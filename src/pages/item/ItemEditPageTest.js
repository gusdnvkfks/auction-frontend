    ...
    return (
        <SafeTopWrapper style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>내 경매 상품 수정</Text>
                <TouchableOpacity>
                    {/* <Text style={styles.headerBtn}>임시저장</Text> */}
                </TouchableOpacity>
            </View>
            <ScrollView style={styles.scrollArea} contentContainerStyle={{ padding: 16, paddingBottom: 120 }}>
                ...
                {/* 경매 시작 시간 */}
                <Text style={styles.label}>경매 시작 시간</Text>
                ...
                {/* 경매 마감 시간 */}
                <Text style={styles.label}>경매 마감 시간</Text>
                    <View style={styles.optionRow}>
                    {END_OPTIONS.map(opt => (
                        <TouchableOpacity
                        key={opt}
                ...
                <Text style={styles.label}><RequiredLabel />제목</Text>
                <TextInput style={styles.input} value={title} onChangeText={setTitle} />

                <Text style={styles.label}><RequiredLabel />설명</Text>
                <TextInput style={[styles.input, styles.textArea]} multiline value={description} onChangeText={setDescription} />

                <Text style={styles.label}><RequiredLabel />시작가</Text>
                ...
                <Text style={styles.label}>입찰 단위</Text>
